...
```
cat ~/.gitconfig 			(这个也可以查看)
```

![1590325725763](C:\Users\cjm_s\AppData\Roaming\Typora\typora-user-images\1590325725763.png)
...
* 初始化仓库
  ...
  意义：将某个项目目录变为git操作目录，生成git本地仓库。即该项目目录可以使用git管理
  	文件下已经有东西了,也可以用
  	初始化后, 文件夹下多路一个.git的隐藏文件,若以后不想用git管理,把它删除就行
  ```

  ![1590325949010](C:\Users\cjm_s\AppData\Roaming\Typora\typora-user-images\1590325949010.png)
